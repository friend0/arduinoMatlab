...
uint8_t  g_pins[CHANNELS] = {A0, A1, A2}; // Input pins
...
void setup()
{
	...
	g_PPMOut.setPulseLength(300);   // pulse length in microseconds
	g_PPMOut.setPauseLength(5448); // length of pause after last channel in microseconds
